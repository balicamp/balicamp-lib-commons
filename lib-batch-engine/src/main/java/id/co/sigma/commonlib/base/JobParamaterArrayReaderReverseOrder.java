...
/**
 * ini membaca dari parameter reader. data di baca dengan urutan ke balik. dari index yang palong besar ke yang paling kecil
 *@author <a href="mailto:gede.sutarsa@gmail.com">Gede Sutarsa</a>
 */
public abstract class JobParamaterArrayReaderReverseOrder implements ItemReader<Object[]> , ItemReadListener<Object[]>{
	...
	protected void beforeStepHandler( StepExecution stepExecution ) throws Exception {
		...
		currentIndex = countDataToRead-1 ;
